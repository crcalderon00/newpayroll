...
// Use mysqli (OOP) instead of old mysql functions
...
<script type="text/javascript">
    function proceed() {
        return confirm('Do you want to send message to Staff Id <?php echo $staff_id ?>');
    }
</script>
...
<table width="563" border="1" align="center">
  ...
  <tr>
    <td>&nbsp;</td>
    <td><input type="submit" name="submit" id="submit" value="Submit" onclick="return proceed()"/></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
