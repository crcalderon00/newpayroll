...
while ($row = mysqli_fetch_assoc($qry)) {
    ...
    echo "<td>
            <a href='delete.php?staff_id=" . urlencode($row['staff_id']) . "'>Delete</a> | 
            <a href='up_staff.php?staff_id=" . urlencode($row['staff_id']) . "'>Update</a> | 
            <a href='im.php?staff_id=" . urlencode($row['staff_id']) . "'>Send Message</a>
          </td>";
    echo "</tr>";
}
